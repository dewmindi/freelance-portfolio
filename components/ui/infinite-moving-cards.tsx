...
export const InfiniteMovingCards = ({
  ...
  return (
    <div
      ...
      ref={containerRef}
      className={cn(
        "scroller pb-6 relative -z-20 max-w-full overflow-hidden bg-slate-400/60 dark:bg-slate-900",
        className
      )}
    >     <h2 className="text-3xl md:text-5xl font-bold mt-10  text-center text-emerald-500">Trusted by Brands</h2>
      <h1 className="sticky text-center mt-7 text-xl  text-light-text dark:text-gray-300 px-2">I've had the privilege of partnering with a diverse range of businesses, helping them grow their digital presence and achieve impactful results.</h1>
      <ul
        ref={scrollerRef}
        className={cn(
          "flex w-max min-w-full shrink-0 flex-nowrap gap-4 py-4",
